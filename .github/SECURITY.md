...
Use the [GitHub Security Advisory](https://github.com/ktestify/ktestify-parent/security/advisories/new)
...
This policy applies to the `ktestify-parent` POM and its direct dependencies.  
